...
if "AWS" in st.session_state:
    col2.toggle("AWS", value=st.session_state.AWS)
if "Microsoft" in st.session_state:
    col2.toggle("Microsoft", value=st.session_state.Microsoft)
if 'Google Cloud' in st.session_state:
    col2.toggle("Google Cloud", value=st.session_state.Google)
if 'Chameleon' in st.session_state:
    col2.toggle("Chameleon", value=st.session_state.Chameleon)
